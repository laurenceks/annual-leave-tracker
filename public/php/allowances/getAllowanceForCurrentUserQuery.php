<?php
$getAllowanceForCurrentUserQuery = "
SELECT
users.id,
allowances.hours as total,
...
FROM users LEFT JOIN allowances ON users.id = allowances.userId LEFT JOIN bookings on users.id = bookings.userId
